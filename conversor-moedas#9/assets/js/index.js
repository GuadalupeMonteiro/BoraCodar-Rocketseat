const selectArea = document.querySelectorAll('.select-area');
const list = document.querySelectorAll('.list');
const arrowRotate = document.querySelectorAll('.select-area svg');

//SHOW LIST
for (let i = 0; i < selectArea.length; i++) {
        selectArea[i].addEventListener('click', (e) => {
                list[i].classList.toggle('hidden')

                if (arrowRotate[i].classList.contains("rotate")) {
                        arrowRotate[i].classList.remove("rotate");
                } else {
                        arrowRotate[i].classList.add("rotate");
                }
        })
}
